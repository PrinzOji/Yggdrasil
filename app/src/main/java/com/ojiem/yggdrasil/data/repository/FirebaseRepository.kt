    ...
    suspend fun seedPresentationData() {
        val dummyUsers = listOf(
            User(
                ...
                profilePicUrl = "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_1",
                isPrivate = false
            ),
            User(
                uid = "agri_seer",
                ...
                profilePicUrl = "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_2",
                isPrivate = true
            )
        )
        
        val dummyReports = listOf(
            PriceReport("r1", "Heirloom Tomatoes", "produce", 350.0, "kg", "Organic Market", null, null, "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_3", "eco_pioneer", "EcoPioneer", 8, true),
            PriceReport("r2", "Local Honey", "staples", 800.0, "jar", "Village Square", null, null, "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_4", "agri_seer", "AgriSeer", 2, false)
        )
        ...
        val dummyStatuses = listOf(
            Status(
                ...
                userId = "eco_pioneer",
                username = "EcoPioneer",
                userProfilePic = "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_1",
                imageUrl = "https://res.cloudinary.com/dovimhvmv/image/upload/v1/yggdrasil/farm_5",
